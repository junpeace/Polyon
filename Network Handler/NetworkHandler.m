...
- (void)connection:(NSURLConnection *)connection didFailWithError:(NSError *)error
{
    ...
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle: @"Error"
                                                    message:@"Sorry, looks like we cannot communicate with the servers. Please check your internet connection and try again."
                                                   delegate:nil
...
//    NSData *rrData=[js dataUsingEncoding:NSUTF8StringEncoding];
    ...
    if (jsonData != nil) { }
        ...
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle: @"Error"
                message: @"Unable to communicate with the servers. Please check your internet connection and try again."
                                                       delegate:nil
                                              cancelButtonTitle:@"OK"
                                              otherButtonTitles:nil];
        [alert show];
